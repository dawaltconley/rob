 ...
 */
    ...
    function bgMenu(element) {
        ...
        this.overlay.classList.add("fill-parent");
        this.bgElement.insertBefore(this.overlay, this.bgElement.firstChild);
    }
    ...
    bgMenu.prototype.setBg = function() {
        ...
        this.bgElement.style.backgroundImage = "url(" + image + ")";
        this.overlay.style.backgroundColor = "rgba(0, 0, 0, " + darkness + ")";
    }
